...
function App() {
  ...
  carInfo.map(car => 
    ...
    <div 
      className={`border rounded-sm w-[30vw] mb-4 cursor-pointer ${carInsurance === car.name ? 'font-primaryBold border-black' : 'font-primaryRegular'}`} // Apply different font if selected
      key={car.name}
